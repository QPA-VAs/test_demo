...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        if (app()->runningInConsole()) {
            // Code that only runs in the console
            return;
        }
        ...
        $general_settings['timezone'] = $general_settings['decimal_points_in_currency'] ?? 'EST';
        ...
        view()->share([
            ...
            'pusher_settings' => $pusher_settings,
            'media_storage_settings' => $media_storage_settings,
            'languages' => $languages,
