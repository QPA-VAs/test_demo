...
'please_enter_budget' => 'Please enter Estimated Cost',
...
'decimal_points_in_currency' => 'Decimal points in currency',
        ...
        'website' => 'Website',
        'phone' => 'Phone',
        'prefer_address_billed' => 'Do you prefer to be addressed and billed as your company or personal?*(required)',
        'prefer_company' => 'Company',
        'preferred_correspondence_email' => 'Preferred Correspondence Email*(required)',
        'preferred_contact_method' => 'Preferred method of contact',
        'applications_used' => 'List the applications you use to run your business or workload. I.e. Canva / Slack',
        'maximum_budget' => 'Do you have a maximum budget per month for VA services?',
        'read_and_understood_terms' => 'I can confirm that I have read and understood the QPA Virtual Assistants terms of business.',
        'agree_terms' => 'Yes',
        'disagree_terms' => 'No',
        'remain_up_to_date_terms' => 'I understand that it is my duty to remain up to date with the QPA Virtual Assistants terms of business which will be cascaded via email where there are changes. I understand I will always be given the option to discontinue my services prior to any changes.',
        'agree_update_terms' => 'Yes',
        'disagree_update_terms' => 'No',
        'insert_signature_name' => 'Insert name as form of signature *(required)',
];
