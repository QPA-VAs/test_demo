...
<div class="container-fluid">
    ...
    <div class="card mt-4">
        <div class="card-body">
            <form id="clientCreateForm" action="{{url('/clients/store')}}" method="POST" class="form-submit-event" enctype="multipart/form-data">
...
{{--                    </div>--}}
                ...
                <div class="row step">
                    <div class="mb-3 col-md-6">
                        <label for="business_name" class="form-label"><?= get_label('business_name', 'Business name') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="text" name="business_name" id="business_name" placeholder="<?= get_label('business_name', 'Business name') ?>" value="{{ old('business_name') }}">
                        @error('business_name')
                        <p class="text-danger text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="address_line_1" class="form-label"><?= get_label('address_line_1', 'Address Line 1') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="text" name="address_line_1" id="address_line_1" placeholder="<?= get_label('address_line_1', 'Address Line 1') ?>" value="{{ old('address_line_1') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="address_line_2" class="form-label"><?= get_label('address_line_2', 'Address Line 2') ?></label>
                        <input class="form-control" type="text" name="address_line_2" id="address_line_2" placeholder="<?= get_label('address_line_2', 'Address Line 2') ?>" value="{{ old('address_line_2') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="state_province_region" class="form-label"><?= get_label('state_province_region', 'State / Province / Region') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="text" name="state_province_region" id="state_province_region" placeholder="<?= get_label('state_province_region', 'State / Province / Region') ?>" value="{{ old('state_province_region') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="postal_zip_code" class="form-label"><?= get_label('postal_zip_code', 'Postal / Zip Code') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="text" name="postal_zip_code" id="postal_zip_code" placeholder="<?= get_label('postal_zip_code', 'Postal / Zip Code') ?>" value="{{ old('postal_zip_code') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" name="website" id="website" placeholder="<?= get_label('website', 'Website') ?>" value="{{ old('website') }}">
                        @error('website')
                        <p class="text-danger text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="phone" class="form-label"><?= get_label('phone', 'Phone') ?> <span class="asterisk">*</span></label>
                        <input class="form-control" type="text" name="phone" id="phone" placeholder="<?= get_label('phone', 'Phone') ?>" value="{{ old('phone') }}">
                        @error('phone')
                        <p class="text-danger text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="prefer_company" class="form-label"><?= get_label('prefer_address_billed', 'Do you prefer to be addressed and billed as your company or personal?*(required)') ?></label>
                        <select class="form-select" name="prefer_company" id="prefer_company">
                            ...
                            <option value="personal" <?php echo old('prefer_company') === 'personal' ? 'selected' : '' ?>><?= get_label('personal', 'Personal') ?></option>
                        </select>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="preferred_correspondence_email" class="form-label"><?= get_label('preferred_correspondence_email', 'Preferred Correspondence Email*(required)') ?></label>
                        <select class="form-select" name="preferred_correspondence_email" id="preferred_correspondence_email">
                            <option value="company" <?php echo old('preferred_correspondence_email') === 'company' ? 'selected' : '' ?>><?= get_label('company', 'Company') ?></option>
                            <option value="personal" <?php echo old('preferred_correspondence_email') === 'personal' ? 'selected' : '' ?>><?= get_label('personal', 'Personal') ?></option>
                        </select>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="preferred_contact_method" class="form-label"><?= get_label('preferred_contact_method', 'Preferred method of contact') ?></label>
                        <input class="form-control" type="text" name="preferred_contact_method" id="preferred_contact_method" placeholder="<?= get_label('preferred_contact_method', 'Preferred method of contact') ?>" value="{{ old('preferred_contact_method') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="applications_used" class="form-label"><?= get_label('applications_used', 'List the applications you use to run your business or workload. I.e. Canva / Slack') ?></label>
                        <input class="form-control" type="text" name="applications_used" id="applications_used" placeholder="<?= get_label('applications_used', 'List the applications you use to run your business or workload. I.e. Canva / Slack') ?>" value="{{ old('applications_used') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="maximum_budget" class="form-label"><?= get_label('maximum_budget', 'Do you have a maximum budget per month for VA services?') ?></label>
                        <input class="form-control" type="text" name="maximum_budget" id="maximum_budget" placeholder="<?= get_label('maximum_budget', 'Do you have a maximum budget per month for VA services?') ?>" value="{{ old('maximum_budget') }}">
                    ...
                    <div class="mb-3 col-md-6">
                        <label class="form-label"><?= get_label('read_and_understood_terms', 'I can confirm that I have read and understood the QPA Virtual Assistants terms of business.') ?> <span class="asterisk">*</span></label><br>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="agree_terms" id="agree_terms_yes" value="Yes" <?php echo old('agree_terms') === 'Yes' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="agree_terms_yes"><?= get_label('agree_terms', 'Yes') ?></label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="agree_terms" id="agree_terms_no" value="No" <?php echo old('agree_terms') === 'No' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="agree_terms_no"><?= get_label('disagree_terms', 'No') ?></label>
                        </div>
                        @error('agree_terms')
                        <p class="text-danger text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-3 col-md-6">
                        <label class="form-label"><?= get_label('remain_up_to_date_terms', 'I understand that it is my duty to remain up to date with the QPA Virtual Assistants terms of business which will be cascaded via email where there are changes. I understand I will always be given the option to discontinue my services prior to any changes.') ?> <span class="asterisk">*</span></label><br>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="agree_update_terms" id="agree_update_terms_yes" value="Yes" <?php echo old('agree_update_terms') === 'Yes' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="agree_update_terms_yes"><?= get_label('agree_update_terms', 'Yes') ?></label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="agree_update_terms" id="agree_update_terms_no" value="No" <?php echo old('agree_update_terms') === 'No' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="agree_update_terms_no"><?= get_label('disagree_update_terms', 'No') ?></label>
                        </div>
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="insert_signature_name" class="form-label"><?= get_label('insert_signature_name', 'Insert name as form of signature *(required)') ?></label>
                        <input class="form-control" type="text" name="insert_signature_name" id="insert_signature_name" placeholder="<?= get_label('insert_signature_name', 'Insert name as form of signature *(required)') ?>" value="{{ old('insert_signature_name') }}">
                ...
                <div class="form-footer d-flex">
                    <button class="btn btn-primary me-2 prevBtn" type="button" id="prevBtn" onclick="nextPrev(-1)">Previous</button>
                    <button class="btn btn-outline-secondary nextBtn ms-2" type="button" id="nextBtn" onclick="nextPrev(1)">Next</button>
