...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between m-4">
            ...
            <div>
                <a href="{{ url('/clients/create') }}"><button type="button" class="btn btn-sm btn-primary"
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex flex-row align-items-center mb-3">
                                                <img class="avatar avatar-md pull-up mr-20"
                                                    src="{{ asset('storage/' . $client->photo) }}" alt="Client Photo">
                                                <div>
                                                    <h5 class="card-title">{{ $client->first_name }}
                                                        {{ $client->last_name }}</h5>
                                                </div>
                                            </div>
                                            ...
                                            <a href="/clients/profile/{{ $client->id }}" class="card-link">Info</a>
                                            <a href="/clients/edit/{{ $client->id }}" class="card-link">Edit</a>
                                            {{-- <a href="/clients/tasks/{{ $client->id }}" class="card-link">Tasklist</a> --}}
