                                        ...
                                        <i class='bx bx-time-five text-success'></i>
                                            ...
                                            if (!function_exists('reformatTime')) {
                                                function reformatTime($input)
                                                {
                                                    ...
                                                    // If minutes exceed 59, convert excess minutes to hours
                                                    if ($minutes >= 60) {
                                                    ...
                                                    $output = $hours . 'hr ' . $minutes . 'mins';

                                                    return $output;
                                                }
                                            }
                                            $time = $project->tasks->first()->total_time_spent ?? 0;
                                            $time = ($time/100);
                                            $hours = substr($time, 0, -2);
                                            $minutes = substr($time, -2);
                                            $formatted_time = sprintf("%dhr %d mins", intval($hours), intval($minutes));
//                                            echo $formatted_time
                                            echo reformatTime($formatted_time);
                                            ?>
